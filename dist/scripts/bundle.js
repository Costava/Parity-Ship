...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorChanger = __webpack_require__(4);
	var FadeBar = __webpack_require__(5);

	var Player = __webpack_require__(6);
	var Ship = __webpack_require__(7);

	var CleanPacket = __webpack_require__(8);
	var Planet = __webpack_require__(9);
				...
				game.ships.some(function (ship, shipIndex, ships) {
					if (!ship.hit) {
						...
						if (distance < colDistance) {
							...
							var fFinalColor = new Color((ship.innerColor.r + 255) / 2, (ship.innerColor.g + 255) / 2, (ship.innerColor.b + 255) / 2, 0);
	...
	ColorChanger.prototype.change = function (dt) {
		if (this.timeLeft > 0) {
			...
			if (dt < this.timeLeft) {
				...
				//dt is greater than or equal to timeLeft
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.startGame = function () {
		...
		(function (self) {
			setTimeout(function () {
				document.addEventListener('click', self.ShootMouse);
			}, 100);
		})(this);
